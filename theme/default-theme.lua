...
local awesome_overrides =
  ...
  theme.taglist_bg_empty = '#19191900'
  theme.taglist_bg_occupied =  '#19191900'
  theme.taglist_bg_urgent =
    'linear:0,0:' ..
    dpi(0) ..
      ',50:0,' ..
        '#363636' ..
          ':0.08,' .. '#D22B2B' .. ':0.08,' .. '#121212' .. ':1,' .. '#121212'
  theme.taglist_bg_focus =
    'linear:0,0:' ..
    dpi(0) ..
      ',50:0,' .. -- tag list top line
        theme.primary.hue_500 ..
          ':0.08,' .. theme.primary.hue_500 .. ':0.08,' .. '#19191900' .. ':1,' .. theme.background.hue_800

  -- Tasklist

  theme.tasklist_font = 'Roboto medium 11'
  theme.tasklist_bg_normal = '#19191900'
  theme.tasklist_bg_focus =
    'linear:0,0:0,' ..
    dpi(40) ..
      ':0,' ..
        '#191919' ..
          ':0.95,' .. '#19191900' .. ':0.95,' .. theme.fg_normal .. ':1,' .. theme.fg_normal
